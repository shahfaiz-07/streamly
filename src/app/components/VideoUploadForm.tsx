        ...
        <div>
            <form onSubmit={handleSubmit} className='my-5 card'>
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4 card-body">
                    <h2 className="card-title mx-auto">Upload a Video</h2>
                    <label className='label'>Title</label>
                    <label className="input input-primary validator">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="h-[1rem] opacity-50">
                        ...
                        <input type="text" placeholder="Video Title" minLength={5} required value={title} onChange={(e) => setTitle(e.target.value)} disabled={!session?.user.username} />
                    </label>
                    <p className="validator-hint hidden">Must be atleast 5 characters</p>
