        ...
        <div className='min-h-full w-full grid place-content-center'>
            <form onSubmit={handleSubmit} className='my-5 card'>
                <fieldset className="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4 card-body">
                    ...
                    <button className="btn btn-outline btn-primary mt-2 w-fit mx-auto" type="submit" disabled={loading || githubLoading || googleLoading || discordLoading}>
                        {
                    ...
                    <button className="btn bg-white text-black border-[#e5e5e5]" disabled={loading || googleLoading || githubLoading || discordLoading} type='button' onClick={handleGoogleSign}>
